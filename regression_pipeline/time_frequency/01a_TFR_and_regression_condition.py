...
for i, subject in enumerate(subjects_list):
    ...
    for conditions in config.condition_pairs:
        report_out  = report_dir + f'{subject}_{"_".join(conditions)}_Condition_TFR_ireg.html'
    ...
    #____________________________________________________
        ...
        f_out_condition = stat_dir + subject + "_"+ pick_type + "_" + epochs_type + "_" + "_".join(conditions) + '_TFR_Condition_beta_reg_' + foi + 'ipower_betas.fif'
        os.makedirs(stat_dir, exist_ok=True)
        ireg['Condition'].beta.save(f_out_condition, overwrite = True)

        f_out_intercept = stat_dir + subject + "_"+ pick_type + "_" + epochs_type + "_" + "_".join(conditions) + '_TFR_Condition_Intercept_reg_' + foi + 'ipower_betas.fif'
        os.makedirs(stat_dir, exist_ok=True)
